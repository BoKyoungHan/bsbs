...
b.attach_kprobe(event="bio_attempt_back_merge",fn_name="bio_attempt_back_merge_entry")
b.attach_kprobe(event="bio_attempt_front_merge",fn_name="bio_attempt_front_merge_entry")
b.attach_kprobe(event="bio_attempt_discard_merge",fn_name="bio_attempt_discard_merge_entry")

b.attach_kprobe(event="blk_mq_start_request", fn_name="blk_mq_start_request_entry")

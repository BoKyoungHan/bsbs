...
BPF_HASH(blk_layer_called_info_map, struct bio * , struct blk_layer_called_info);
...
//		bpf_trace_printk("blk_mq_make, already registered addr , %lu, major, %lu, sector, %u\n",key,major,sector);
		bpf_trace_printk("blk_mq_make, already registered addr , %lu, major, %lu\n",key,major);
	}
...
//              bpf_trace_printk("bio_endio, not in map, %lu, major, %lu, sector, %lu\n",key,major,sector);
...
//	bpf_trace_printk("bio_endio, delete, %lu, major, %lu, sector, %lu\n", key, major, sector);
	bpf_trace_printk("bio_endio, delete, %lu, major, %lu, size, %lu\n", key, major, psize);
